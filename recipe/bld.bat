...
@REM --- Download zlib ---
git clone "https://github.com/madler/zlib.git" "deps\zlib"
if errorlevel 1 exit 1
git -C "deps\zlib" checkout "%ZLIB_COMMIT%"
if errorlevel 1 exit 1

@REM --- Download zstd ---
git clone "https://github.com/facebook/zstd.git" "deps\zstd"
if errorlevel 1 exit 1
git -C "deps\zstd" checkout "%ZSTD_COMMIT%"
if errorlevel 1 exit 1
